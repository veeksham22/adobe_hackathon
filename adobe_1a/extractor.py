...
def is_visible_text(text):
    # Removes control chars and invisible symbols
...
def extract_outline_from_pdf(pdf_path):
    ...
    # Step 1: Build font size frequency map
    ...
    # Step 2: Determine top font sizes → heading levels
